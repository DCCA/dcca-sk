---
name: daily-review
description: Rotina pessoal de fechamento do dia anterior e preparação do dia atual. Puxa de todas as fontes disponíveis (calendário, e-mail, Slack, GitHub, transcrições de reunião), reconstrói o que aconteceu, rastreia compromissos nos dois sentidos (os que você assumiu e os que estão te devendo) e monta o plano de hoje. Use sempre que o usuário disser "daily", "review diário", "fechar o dia", "revisar ontem", "preparar meu dia", "o que tenho hoje", "começar o dia" ou pedir qualquer rotina de manhã/início de expediente — mesmo que não diga a palavra "daily" explicitamente.
---
