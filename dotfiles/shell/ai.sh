...
#
# Fluxo: edite este arquivo e rode `./install.sh` pra instalar em toda maquina;
# `./capture.sh` traz mudancas de shell de volta. Sem segredo aqui (repo
# publico): nada de `export ANTHROPIC_API_KEY=...` etc.
